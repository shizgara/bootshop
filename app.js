...
const {DBUSERNAME, DBPASSWORD} = require("./helper/database");
...
mongoose
  .connect(
    `mongodb+srv://${DBUSERNAME}:${DBPASSWORD}@cluster0.cvhh2.mongodb.net/Bootshop?retryWrites=true&w=majority`,//Тут вводять пароль,пасворд і назва бд
